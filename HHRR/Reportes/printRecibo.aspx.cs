...
{
    public partial class printRecibo : System.Web.UI.Page
    {
        ...
        private void ShowPdf(byte[] strS)
        {
            ...
            string mesStr = Request.QueryString["nro_liq"];
            string des_liq = Request.QueryString["liquidacion"];
            int mes = 0;
            if (!int.TryParse(mesStr, out mes))
                mes = 0; // se podria manejar un error aquí

            //string nombreArchivo = string.Format("Recibo_{0}_{1}.pdf", anio, mes.ToString("D2"));
            string nombreArchivo = string.Format("Recibo_{0}.pdf", des_liq);
        ...
        private PdfPTable getEncabezado(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                tblEncabezado.SetWidths(new float[] { 25, 50, 25 });
        ...
        private PdfPTable getEncabezado2(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                Linea11.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea11.SpacingAfter = 0f;
                Linea11.SpacingBefore = 0f;
                Linea11.PaddingTop = 0f;
                Linea11.SetLeading(12, 0);
                ...
                Linea12.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea12.SpacingAfter = 0f;
                Linea12.SpacingBefore = 0f;
                Linea12.PaddingTop = 0f;
                Linea12.SetLeading(12, 0);
                ...
                Linea13.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea13.SpacingAfter = 0f;
                Linea13.SpacingBefore = 0f;
                Linea13.PaddingTop = 0f;
                Linea13.SetLeading(12, 0);
                ...
                Linea14.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea14.SpacingAfter = 0f;
                Linea14.SpacingBefore = 0f;
                Linea14.PaddingTop = 0f;
                Linea14.SetLeading(12, 0);
                ...
                Linea15.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea15.SpacingAfter = 0f;
                Linea15.SpacingBefore = 0f;
                Linea15.PaddingTop = 0f;
                Linea15.SetLeading(12, 0);
        ...
        private PdfPTable getEncabezado3(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                Linea23.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea23.SpacingAfter = 0f;
                Linea23.SpacingBefore = 0f;
                Linea23.PaddingTop = 0f;
                Linea23.SetLeading(12, 0);
        ...
        private PdfPTable getEncabezado4(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                Linea1Det.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea1Det.SpacingAfter = 0f;
                Linea1Det.SpacingBefore = 0f;
                Linea1Det.PaddingTop = 0f;
                Linea1Det.SetLeading(12, 0);
                ...
                Linea2Det.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea2Det.SpacingAfter = 0f;
                Linea2Det.SpacingBefore = 0f;
                Linea2Det.PaddingTop = 0f;
                Linea2Det.SetLeading(12, 0);
        ...
        private PdfPTable getDetalle(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                tblEncabezado.SetWidths(new float[] { 10, 35, 10, 15, 15, 15 });
                int i = 0;
                foreach (var item in lstDetallle)
                {
                    ...
                    Linea16.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                    Linea16.SpacingAfter = 0f;
                    Linea16.SpacingBefore = 0f;
                    Linea16.PaddingTop = 0f;
                    Linea16.SetLeading(12, 0);
                ...
                for (int j = i; j <= 27; j++)
                {
                    ...
                    Paragraph Linea11 = new Paragraph();
                    Linea11.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea11.SpacingAfter = 0f;
                    Linea11.SpacingBefore = 0f;
                    Linea11.PaddingTop = 0f;
                    Linea11.SetLeading(12, 0);
                    ...
                    Paragraph Linea12 = new Paragraph();
                    Linea12.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea12.SpacingAfter = 0f;
                    Linea12.SpacingBefore = 0f;
                    Linea12.PaddingTop = 0f;
                    Linea12.SetLeading(12, 0);
                    ...
                    Paragraph Linea13 = new Paragraph();
                    Linea13.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea13.SpacingAfter = 0f;
                    Linea13.SpacingBefore = 0f;
                    Linea13.PaddingTop = 0f;
                    Linea13.SetLeading(12, 0);
                    ...
                    Paragraph Linea14 = new Paragraph();
                    Linea14.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea14.SpacingAfter = 0f;
                    Linea14.SpacingBefore = 0f;
                    Linea14.PaddingTop = 0f;
                    Linea14.SetLeading(12, 0);
                    ...
                    Paragraph Linea15 = new Paragraph();
                    Linea15.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea15.SpacingAfter = 0f;
                    Linea15.SpacingBefore = 0f;
                    Linea15.PaddingTop = 0f;
                    Linea15.SetLeading(12, 0);
                    ...
                    Paragraph Linea16 = new Paragraph();
                    Linea16.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL, BaseColor.WHITE));
                    Linea16.SpacingAfter = 0f;
                    Linea16.SpacingBefore = 0f;
                    Linea16.PaddingTop = 0f;
                    Linea16.SetLeading(12, 0);
        ...
        private PdfPTable getTotal2(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                tblEncabezado.SetWidths(new float[] { 55, 15, 15, 15 });
                ...
                Linea24.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea24.SpacingAfter = 0f;
                Linea24.SpacingBefore = 0f;
                Linea24.PaddingTop = 0f;
                Linea24.SetLeading(12, 0);
                ...
                Linea25.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea25.SpacingAfter = 0f;
                Linea25.SpacingBefore = 0f;
                Linea25.PaddingTop = 0f;
                Linea25.SetLeading(12, 0);
                ...
                Linea26.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea26.SpacingAfter = 0f;
                Linea26.SpacingBefore = 0f;
                Linea26.PaddingTop = 0f;
                Linea26.SetLeading(12, 0);
        ...
        private PdfPTable getTotal3(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                Paragraph Linea24 = new Paragraph();
                Linea24.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.BOLD));
                Linea24.SpacingAfter = 0f;
                Linea24.SpacingBefore = 0f;
                Linea24.PaddingTop = 0f;
                Linea24.SetLeading(12, 0);
                ...
                Paragraph Linea25 = new Paragraph();
                Linea25.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.BOLD));
                Linea25.SpacingAfter = 0f;
                Linea25.SpacingBefore = 0f;
                Linea25.PaddingTop = 0f;
                Linea25.SetLeading(12, 0);
        ...
        private PdfPTable getTotal4(PdfWriter wri, List<sueldo_detalle> lstDetallle)
        {
            try
            {
                ...
                Paragraph Linea12 = new Paragraph();
                Linea12.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea12.SpacingAfter = 35f;
                Linea12.SpacingBefore = 0f;
                Linea12.PaddingTop = 0f;
                Linea12.SetLeading(12, 0);
                Linea12.Alignment = Element.ALIGN_LEFT;
                Linea12.Add("Ud. Se encuentra con cobertura de ASOCIART ART. AT. MEDICA 24hs. 0800-888-0093");
                ...
                Linea21.Font = new Font(FontFactory.GetFont("Calibri", 7, Font.NORMAL));
                Linea21.SpacingAfter = 5f;
                Linea21.SpacingBefore = 0f;
                Linea21.PaddingTop = 0f;
                Linea21.SetLeading(12, 0);
        ...
        {
            Document doc = new Document(PageSize.A4, 40, 40, 30, 20);
            ...
            using (MemoryStream output = new MemoryStream())
            {
                ...
                doc.Add(getEncabezado(wri, lstDetallle));
                doc.Add(getEncabezado2(wri, lstDetallle));
                doc.Add(getEncabezado3(wri, lstDetallle));
                doc.Add(getEncabezado4(wri, lstDetallle));
                doc.Add(getDetalle(wri, lstDetallle));
                doc.Add(getTotal(wri, lstDetallle));
                doc.Add(getTotal2(wri, lstDetallle));
                doc.Add(getTotal3(wri, lstDetallle));
                doc.Add(getTotal4(wri, lstDetallle));
                //doc.Add(getTitular(objCedulon));
                //doc.Add(getBien(wri, objCedulon));
                //doc.Add(getNota());
                //doc.Add(getDetalleTitulo());
                //doc.Add(getDetalle(objCedulon, ref lineas));
                //if (lineas > 6 && lineas < 31)
                //    doc.NewPage();
                //doc.Add(tblPie1);
                //doc.Add(tblPie2);
                //doc.Add(getPieIzquierda(objCedulon));
                //doc.Add(getPie2(wri, objCedulon));
